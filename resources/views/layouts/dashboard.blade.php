        ...
        <div class="w-28 mb-8 bg-mainblue h-full flex items-center flex-col justify-between py-14">
            ...
            <div class="flex flex-col">
                <a href="{{ route('dashboard') }}"
                    class="flex justify-center items-center w-20 h-20 rounded-full flex-col @if (Route::current()->getName() == 'dashboard') bg-bluelowopacity @endif">
                ...
                <a href="{{ route('dashboard.stats') }}"
                    class="mt-6 flex justify-center items-center w-20 h-20 rounded-full flex-col @if (Route::current()->getName() == 'dashboard.stats') bg-bluelowopacity @endif">
                ...
                <a href="{{ route('dashboard.actions.reports') }}"
                    class="mt-6 flex justify-center items-center w-20 h-20 rounded-full flex-col @if (Route::current()->getName() == 'dashboard.actions.reports' ||
                        Route::current()->getName() == 'dashboard.actions.events') bg-bluelowopacity @endif">
                    <img src="{{ asset('/icons/action-icon.png') }}" class="w-8" alt="home">
                    <span class="font-inter text-[10px] mt-1 text-white">Action</span>
                </a>
                <a href="{{ route('dashboard.settings') }}"
                    class="mt-6 flex justify-center items-center w-20 h-20 rounded-full flex-col @if (Route::current()->getName() == 'dashboard.settings') bg-bluelowopacity @endif">
            ...
            this.closest('form').submit();"><img
                            src="{{ asset('/icons/logout-icon.png') }}" class="w-8" alt=""></a>
                </form>
            </div>
        </div>
            ...
            <div class="h-[86px] flex justify-between items-center">
                ...
                <div class="flex max-w-md">
                    ...
                    <a class="cursor-pointer mr-10 relative">
                        ...
                        @if (false)
                            <div
                                class="w-3 flex justify-center items-center h-3 rounded-full right-0 bg-white absolute top-2">
